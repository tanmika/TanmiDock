  ...
  describe('RegistryManager', () => {
    ...
    it('should load existing registry', async () => {
      const existingRegistry = {
        version: '1.0.0',
        projects: { 'abc123': { path: '/test', configPath: '/test/codepac-dep.json', lastLinked: '2026-01-01', platform: 'mac', dependencies: [] } },
        libraries: {},
      }
    ...
    describe('removeProject', () => {
      it('should remove project and its references', async () => {
        ...
        const project = {
          ...
          lastLinked: '2026-01-05',
          platform: 'mac' as const,
          dependencies: [{ libName: 'mylib', commit: 'abc123', linkedPath: '/test/project/3rdparty/mylib' }],
        }
        registry.addProject(project)
